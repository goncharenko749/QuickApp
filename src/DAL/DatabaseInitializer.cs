    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "admin", "Inbuilt Administrator", "admin@admin.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "user", "Inbuilt Standard User", "user@user.com", "+1 (123) 000-0001", new string[] { userRoleName });
            ...
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                {
                    Name = "Vladimir Guzarik",
                    Email = "guzzzarik@gmailcom",
                    PhoneNumber = "+375251111111",
                    Address = "Minsk, Pushkina 223",
                    City = "Minsk",
                    Gender = Gender.Male,
                    DateCreated = DateTime.UtcNow,
                    DateModified = DateTime.UtcNow
                ...
                {
                    Name = "Ivan Buiko",
                    Email = "buiko@gmail.com",
                    PhoneNumber = "+37533333333",
                    Address = "Grodno, Timiryzeva 13",
                    City = "Grodno",
                    Gender = Gender.Male,
                    DateCreated = DateTime.UtcNow,
                    DateModified = DateTime.UtcNow
